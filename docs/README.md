...
| Minecraft     | 25565/19132   | minecraft.jsamo.com             | games      | Paper server + Bedrock support |
| MC Admin      | 4326          | mc-admin.jsamo.com              | games      | RCON web admin panel           |
| MC Backup     | -             | -                               | games      | Automated world backups        |
...
- [Minecraft Server Setup](./guides/minecraft-setup.md) - Game server with Bedrock support
...
| `RCON_WEB_PASSWORD`| RCON web admin panel password        |
| `TZ`               | Timezone (e.g., Australia/Sydney)    |
